...
/// Mirrors what the analyzer reports for a Flutter/dart:ui type: the DEFINING
/// library, not the public export. The emitter maps both onto the single
/// `package:flutter/widgets.dart` import.
const Map<String, String> _colorOrigin = {'Color': 'dart:ui'};

const Map<String, String> _textStyleOrigin = {
  'TextStyle': 'package:flutter/src/painting/text_style.dart',
};

String _flutterLibrary(String name) => switch (name) {
      'Color' || 'Offset' || 'Size' => 'dart:ui',
      'TextStyle' => 'package:flutter/src/painting/text_style.dart',
      ...
      _ => 'package:flutter/widgets.dart',
    };
...
const SurfaceClass _crosshairConfig = SurfaceClass(
  ...
  hasCopyWith: true,
  copyWithReturnType: 'CrosshairConfig',
...
const String _expectedInteractionConfigFluent = '''// GENERATED by surface_gen — do not edit.
//
...
SurfaceParam _triState(String name, String payload) => SurfaceParam(
      ...
      typeOrigins: {
        'ChartStyleValue':
            'package:braven_charts/src/models/chart_style_value.dart',
        if (payload != 'double') payload: _flutterLibrary(payload),
      },
    );
...
final SurfaceClass _cartesianValueSummaryStyle = SurfaceClass(
  ...
  isConstConstructible: true,
  hasCopyWith: true,
  copyWithReturnType: 'CartesianValueSummaryStyle',
  params: [
...
const String _expectedCartesianValueSummaryStyleFluent = '''// GENERATED by surface_gen — do not edit.
//
// Fluent modifier extensions generated from the @chartSurface annotations in
// package:braven_charts/src/models/cartesian_value_summary_style.dart.
// Regenerate: dart run build_runner build
...
const SurfaceClass _lineChartSeries = SurfaceClass(
  ...
  isConstConstructible: true,
  hasCopyWith: true,
  copyWithReturnType: 'LineChartSeries',
  params: [
    SurfaceParam(
      name: 'id',
      dartType: 'String',
...
const String _expectedChartSeriesFluent = '''// GENERATED by surface_gen — do not edit.
//
// Fluent modifier extensions generated from the @chartSurface annotations in
...
const SurfaceClass _axisWithCombined = SurfaceClass(
  ...
  isConstConstructible: true,
  hasCopyWith: true,
  copyWithReturnType: 'FixtureAxisConfig',
  combinedSetters: [
...
extension FixtureAxisConfigFluent on FixtureAxisConfig {
  ...
  ///
  /// No clear verb: this class's copyWith cannot unset
  /// [FixtureAxisConfig.label]; construct a new instance to reset it.
...
const SurfaceClass _seriesWithClearFlag = SurfaceClass(
  ...
  isConstConstructible: true,
  hasCopyWith: true,
  copyWithReturnType: 'FixtureScatterSeries',
  params: [
    SurfaceParam(
      name: 'markerStyle',
...
const SurfaceClass _configWithExclusions = SurfaceClass(
  ...
  isConstConstructible: true,
  hasCopyWith: true,
  copyWithReturnType: 'FixtureCallbackConfig',
  params: [
    SurfaceParam(
      name: 'label',
      dartType: 'String?',
...
extension FixtureCallbackConfigFluent on FixtureCallbackConfig {
  ...
  ///
  /// No clear verb: this class's copyWith cannot unset
  /// [FixtureCallbackConfig.label]; construct a new instance to reset it.
...
const SurfaceClass _allExcluded = SurfaceClass(
  ...
  isConstConstructible: true,
  hasCopyWith: true,
  copyWithReturnType: 'FixtureCallbacksOnly',
  params: [
    SurfaceParam(
      name: 'onTap',
      dartType: 'void Function()?',
...
///
/// It carries a perfectly emittable parameter on purpose: without one, the
/// `hasCopyWith` guard could be deleted and this fixture would still emit
/// nothing (mutation-test gap E16b).
  ...
  group('emission rules', () {
    ...
    test('combined setter with unknown param names fails loudly', () {
      const broken = SurfaceClass(
        ...
        isConstConstructible: true,
        hasCopyWith: true,
        copyWithReturnType: 'FixtureBroken',
        combinedSetters: [
