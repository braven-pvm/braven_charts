                      ...
                      OutlinedButton(
                        ...
                        style: OutlinedButton.styleFrom(
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(8.0), // Adjust value for more/less roundness
                          ),
                          backgroundColor: Colors.grey.shade300.withAlpha(60),
                          padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 6),
                          side: BorderSide(width: 0.5, color: Colors.grey.shade300), // Optional: define border width/color
                        ),
