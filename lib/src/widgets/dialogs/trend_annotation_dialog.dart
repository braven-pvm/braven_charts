...
class _TrendAnnotationDialogState extends State<TrendAnnotationDialog> {
  ...
  Widget _buildLabelPositionSelector() {
    ...
    return Column(
      ...
      children: [
        Text('Label Position', style: Theme.of(context).textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.w500)),
            ...
            return InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(6),
                  border: Border.all(color: isSelected ? Theme.of(context).colorScheme.primary : Colors.grey.shade300, width: 1),
                ),
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      label,
                      style: TextStyle(fontSize: 10, fontWeight: FontWeight.w500, color: isSelected ? Colors.white : Colors.grey[700]),
                    ),
                  ],
                ),
              ),
