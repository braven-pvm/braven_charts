...
class RangeAnnotationElement extends ChartElement with ResizableElement {
  ...
  /// Returns the current temporary resize/move bounds, or null if not active.
  Rect? get tempResizeBounds => _tempResizeBounds;
...
class LegendAnnotationElement extends ChartElement {
  ...
  @override
  void paint(Canvas canvas, Size size) {
    if (_bounds == null || (annotation.series.isEmpty && annotation.trendAnnotations.isEmpty)) {
      return;
    }
