...
void main() {
  ...
  group('YAxisConfig API Surface (via series)', () {
    ...
    test('MISSING: visible - NOT exposed', () {
      expect(seriesProps.containsKey('yAxisVisible'), isFalse, reason: 'DOCUMENTED GAP: yAxisVisible not exposed');
    });

    test('MISSING: showAxisLine - NOT exposed', () {
      expect(seriesProps.containsKey('yAxisShowAxisLine'), isFalse, reason: 'DOCUMENTED GAP: yAxisShowAxisLine not exposed');
    });

    test('MISSING: showTicks - NOT exposed', () {
      expect(seriesProps.containsKey('yAxisShowTicks'), isFalse, reason: 'DOCUMENTED GAP: yAxisShowTicks not exposed');
    });

    test('MISSING: tickCount - NOT exposed', () {
      expect(seriesProps.containsKey('yAxisTickCount'), isFalse, reason: 'DOCUMENTED GAP: yAxisTickCount not exposed');
    });
  });
  ...
  group('Annotation Types API Surface', () {
    ...
    test('MISSING: TrendAnnotation - NOT exposed', () {
      ...
      final annotProps = annotationsItems['properties'] as Map;
      final typeEnum = annotProps['type']['enum'] as List;
      expect(typeEnum, isNot(contains('trendLine')), reason: 'DOCUMENTED GAP: TrendAnnotation not exposed');
    });
  });
  ...
  group('API Coverage Summary', () {
    ...
    test('COUNT: Annotation gaps', () {
      ...
      expect(annotationGaps, equals(2), reason: '2 annotation type gaps documented');
    });
    ...
    test('TOTAL: All documented gaps', () {
      ...
      expect(totalGaps, equals(28), reason: '28 TOTAL documented feature gaps between braven_charts and braven_agent');
    });
  });
}
