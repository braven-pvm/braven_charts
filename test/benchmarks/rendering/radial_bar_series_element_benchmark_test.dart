...
void main() {
  test('512-track Radial Bar warm paint stays within one frame', () {
    ...
    final series = RadialBarChartSeries.fromMap(
      ...
      radialBarStyle: const RadialBarStyle(showDataLabels: false),
    );
    ...
    print(
      'Radial Bar paint (512 tracks, labels hidden): '
    ...
    expect(
      ...
      lessThan(16.67),
      reason:
          'A cached dense Radial Bar element must paint inside the 60fps '
          'frame budget.',
    );
  });
}
