...
void main() {
  group('ChartScrollbar handle size accuracy - CONTRACT', () {
    testWidgets('MUST render handle at 100% size when viewport equals data range',
    ...
    testWidgets('MUST render handle at 50% size when viewport is half of data range',
        (WidgetTester tester) async {
    ...
    testWidgets('MUST render handle at 10% size when viewport is 10% of data range',
        (WidgetTester tester) async {
    ...
    testWidgets('MUST clamp handle to minimum size (20px) at extreme zoom',
        (WidgetTester tester) async {
    ...
    testWidgets('MUST update handle size when viewport range changes',
        (WidgetTester tester) async {
    ...
    testWidgets('MUST respect vertical orientation for handle size calculation',
        (WidgetTester tester) async {
    ...
    testWidgets('MUST handle zero data range gracefully (edge case)',
        (WidgetTester tester) async {
    ...
    testWidgets('MUST apply custom minimum handle size from theme',
        (WidgetTester tester) async {
