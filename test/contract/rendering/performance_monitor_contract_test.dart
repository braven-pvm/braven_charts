  ...
  group('PerformanceMonitor Contract Tests', () {
    ...
    group('Contract Requirement 2: Timing Accuracy', () {
      test('frame time measurement accurate to ±0.5ms', () async {
        ...
        expect(measuredMs, greaterThanOrEqualTo(3), reason: 'Should measure at least 3ms (5ms - 2ms tolerance)');
        expect(measuredMs, lessThanOrEqualTo(10), reason: 'Should measure at most 10ms (5ms + 5ms platform variance)');
      });
