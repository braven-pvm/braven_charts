...
void main() {
  ...
  group('Segment tap fires onRegionSelected', () {
    testWidgets('tap on chart with styled series delivers segment region', (
      WidgetTester tester,
    ) async {
      // Arrange
      ...
      // Act — tap the center of the chart
  ...
  group('Non-adjacent same-style contiguity verification', () {
    testWidgets(
      'blue 0-4, red 5-9, blue 10-14: tap in right portion returns second blue group',
      (WidgetTester tester) async {
        // Arrange
        ...
        // Act — tap in the right portion of the chart where the second blue
        // group (10-14) should be rendered
