      ...
      test('hasMultipleYAxes returns false with single axis config', () {
        manager.setSeries([
          ChartSeries(
            ...
            name: 'Series 1',
            points: const [],
            yAxisConfig: YAxisConfig(id: 'axis1', position: YAxisPosition.left),
          ),
        ]);
        expect(manager.hasMultipleYAxes(), isFalse);
      });
      ...
      test('hasMultipleYAxes returns true with multiple axis configs', () {
        manager.setSeries([
          ...
          ChartSeries(
            ...
            name: 'Series 2',
            points: const [],
            yAxisConfig: YAxisConfig(id: 'axis2', position: YAxisPosition.right),
          ),
        ]);
      ...
      test('getEffectiveYAxes deduplicates axes with same ID', () {
        manager.setSeries([
          ChartSeries(
            ...
            name: 'Series 1',
            points: const [],
            yAxisConfig: YAxisConfig(id: 'shared', position: YAxisPosition.left),
          ),
          ChartSeries(
            id: 's2',
            name: 'Series 2',
      ...
      test('getEffectiveBindings prioritizes yAxisConfig over yAxisId', () {
        manager.setSeries([
          ChartSeries(
            ...
            name: 'Series 1',
            points: const [],
            yAxisConfig: YAxisConfig(id: 'inline_axis', position: YAxisPosition.left),
            yAxisId: 'referenced_axis',
          ),
        ]);
