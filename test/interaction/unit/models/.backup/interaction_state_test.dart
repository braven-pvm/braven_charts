...
void main() {
  group('InteractionState Model Tests', () {
    test('InteractionState.initial() creates default state', () {
      ...
      expect(() {
        final state = const InteractionState.initial();
    ...
    test('copyWith() creates new instance with updated fields', () {
      // EXPECTED TO FAIL - No implementation exists
      expect(() {
        final initial = const InteractionState.initial();
    ...
    test('hasHoveredPoint returns true when hoveredPoint is not null', () {
      ...
      expect(() {
        ...
        final state = const InteractionState.initial().copyWith(
    ...
    test('validation: isCrosshairVisible=true requires crosshairPosition', () {
      ...
      expect(() {
        ...
        expect(
          () => const InteractionState.initial().copyWith(
            isCrosshairVisible: true,
    ...
    test('equality: two states with same values are equal', () {
      // EXPECTED TO FAIL - No implementation exists
      expect(() {
        final state1 = const InteractionState.initial();
        final state2 = const InteractionState.initial();
