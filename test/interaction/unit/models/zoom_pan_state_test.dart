...
void main() {
  group('ZoomPanState Model Tests', () {
    ...
    test('animateTo() interpolates zoom levels', () {
      // EXPECTED TO FAIL - No implementation exists
      expect(() {
        final start = ZoomPanState.initial(testDataBounds);
    ...
    test('validation: minZoomLevel must be > 0', () {
      ...
      expect(() {
        expect(
          () => ZoomPanState.initial(testDataBounds).copyWith(
    ...
    test('complex scenario: zoom in and pan', () {
      ...
      expect(() {
        final state = ZoomPanState.initial(testDataBounds)
            .copyWith(zoomLevelX: 2.0, zoomLevelY: 2.0)
            .copyWith(panOffset: const Offset(25, 25));
