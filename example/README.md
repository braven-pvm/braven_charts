...
| Technical Indicators | Compose a native 20-session Range Area volatility envelope with Candlestick and Line overlays, synchronized volume/MACD/momentum panes, a configurable persistent tracking guide and translucent focus band, gap-free seam-overlay pane handles, and one resizable shared navigator |
