          ...
          children: [
            ...
            Expanded(
              child: BravenChartPlus(
                ...
                theme: isDark ? ChartTheme.dark : ChartTheme.light,
                showLegend: false,
                xAxis: const AxisConfig(label: 'Hour'),
                yAxis: const AxisConfig(label: '°C'),
              ),
            ),
          ],
        ),
          ...
          children: [
            ...
            Expanded(
              child: BravenChartPlus(
                ...
                showLegend: false,
                xAxis: const AxisConfig(label: 'Month'),
                yAxis: const AxisConfig(label: 'USD'),
              ),
            ),
          ],
        ),
          ...
          children: [
            ...
            Expanded(
              child: BravenChartPlus(
                ...
                showLegend: true,
                xAxis: const AxisConfig(label: 'Hour'),
                yAxis: const AxisConfig(label: 'Mbps / ms'),
              ),
            ),
          ],
        ),
          ...
          children: [
            ...
            Expanded(
              child: BravenChartPlus(
                ...
                showLegend: true,
                xAxis: const AxisConfig(label: 'Month'),
                yAxis: const AxisConfig(label: 'K USD'),
              ),
            ),
          ],
        ),
