      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              '3 local Y scales · shared cursor and viewport · full-domain navigator',
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: CartesianNavigator(
                      ...
                      overviewSeries: const AreaChartSeries(
                        id: 'sync-navigator-elevation',
                        name: 'Route overview',
                        color: Color(0xFF059669),
                        interpolation: LineInterpolation.monotone,
                        strokeWidth: 1.5,
                      ...
                      semanticLabel: 'Route distance range',
                    ),
                  ),
                ],
              ),
