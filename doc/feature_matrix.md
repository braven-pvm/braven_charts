...
| Heatmap charts | `HeatmapDataPoint`, explicit missing cells, `HeatmapChartSeries`, sequential/diverging/threshold `HeatmapColorScale`, categorical X/Y axes, `HeatmapColorLegend`, deterministic entrance and stable-identity update motion, viewport culling, typed interaction, bounded semantics, artifacts, tables, generated Source, Grammar, and fluent configuration | Heatmap Charts, Chart Types, Gallery |
