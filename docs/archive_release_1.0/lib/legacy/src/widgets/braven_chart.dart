...
class _BravenChartState extends State<BravenChart> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveYAxis = widget.yAxis ?? LegacyAxisConfig.defaults().copyWith(axisPosition: AxisPosition.left);
  ...
  double _calculateAxisPadding(LegacyAxisConfig axis, _DataBounds bounds, bool isXAxis) {
...
class _BravenChartPainter extends CustomPainter {
  ...
  double _calculateAxisReservedSize(LegacyAxisConfig axis, _DataBounds bounds, bool isXAxis) {
    // If user provided explicit size, use it
    if (axis.reservedSize != null) {
      return axis.reservedSize!;
    }
