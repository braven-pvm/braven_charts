...
//
// Defines styling for major and minor grid lines.
// Supports solid and dashed lines with configurable colors and widths.
...
class GridStyle {
  const GridStyle({
    ...
    this.showMinor = false,
       ...
       assert(
         ...
         'minorWidth must be >= 0',
       ),
       assert(
         !showMinor || (minorColor != null && minorWidth != null),
  ...
  /// Dash pattern for major grid lines. Null = solid line.
  ...
  /// Dash pattern for minor grid lines. Null = solid line.
