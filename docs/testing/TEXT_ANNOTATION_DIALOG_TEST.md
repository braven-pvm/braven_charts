...
**Steps (continued):**
6. Enter valid text: "Important Note"
7. Click "Add" button
...
**Steps (continued):**
5. Select a custom color (e.g., lime green)
6. Click "Select"
...
**Steps (alternative):**
5. Open dialog again
6. Enter text and make changes
7. Click "X" close button in top right
...
**Steps (alternative):**
8. Open dialog again
9. Press Escape key (if supported)
