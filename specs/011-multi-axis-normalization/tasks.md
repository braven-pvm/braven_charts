...
- [X] T019 [US1] Implement per-axis Y normalization in `lib/src_plus/rendering/multi_axis_normalizer.dart`
...
- [X] T024 [US1] Add example multi-axis chart to showcase in `example/lib/showcase_plus/pages/scientific_data_page.dart`
...
- [X] T035 [US3] Apply color to axis labels in Y-axis renderer in `lib/src_plus/rendering/y_axis_renderer.dart`
...
- [X] T049 [P] Add API documentation to all public classes in `lib/src_plus/axis/`
